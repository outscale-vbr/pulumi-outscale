...
func (o GetSnapshotExportTasksResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetSnapshotExportTasksResult] {
	return pulumix.Output[GetSnapshotExportTasksResult]{
