...
func (i *NicLink) ToOutput(ctx context.Context) pulumix.Output[*NicLink] {
	return pulumix.Output[*NicLink]{
		OutputState: i.ToNicLinkOutputWithContext(ctx).OutputState,
	}
}
...
func (i NicLinkArray) ToOutput(ctx context.Context) pulumix.Output[[]*NicLink] {
	return pulumix.Output[[]*NicLink]{
		OutputState: i.ToNicLinkArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NicLinkMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NicLink] {
	return pulumix.Output[map[string]*NicLink]{
		OutputState: i.ToNicLinkMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NicLinkOutput) ToOutput(ctx context.Context) pulumix.Output[*NicLink] {
	return pulumix.Output[*NicLink]{
...
func (o NicLinkArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NicLink] {
	return pulumix.Output[[]*NicLink]{
		OutputState: o.OutputState,
	}
}
...
func (o NicLinkMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NicLink] {
	return pulumix.Output[map[string]*NicLink]{
		OutputState: o.OutputState,
	}
}
