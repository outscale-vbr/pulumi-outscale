...
func (i *LoadBalancerVms) ToOutput(ctx context.Context) pulumix.Output[*LoadBalancerVms] {
	return pulumix.Output[*LoadBalancerVms]{
		OutputState: i.ToLoadBalancerVmsOutputWithContext(ctx).OutputState,
	}
}
...
func (i LoadBalancerVmsArray) ToOutput(ctx context.Context) pulumix.Output[[]*LoadBalancerVms] {
	return pulumix.Output[[]*LoadBalancerVms]{
		OutputState: i.ToLoadBalancerVmsArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i LoadBalancerVmsMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*LoadBalancerVms] {
	return pulumix.Output[map[string]*LoadBalancerVms]{
		OutputState: i.ToLoadBalancerVmsMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o LoadBalancerVmsOutput) ToOutput(ctx context.Context) pulumix.Output[*LoadBalancerVms] {
	return pulumix.Output[*LoadBalancerVms]{
...
func (o LoadBalancerVmsArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*LoadBalancerVms] {
	return pulumix.Output[[]*LoadBalancerVms]{
		OutputState: o.OutputState,
	}
}
...
func (o LoadBalancerVmsMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*LoadBalancerVms] {
	return pulumix.Output[map[string]*LoadBalancerVms]{
		OutputState: o.OutputState,
	}
}
