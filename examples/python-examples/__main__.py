...
#security_group_rule = outscale.SecurityGroupRule(resource_name="demo-pulumi-sgr", flow="Inbound", security_group_id=security_group.id, rules=outscale.SecurityGroupRuleRuleArgs(from_port_range="22", to_port_range="22", ip_protocol="tcp", ip_ranges=["0.0.0.0/0"]))
